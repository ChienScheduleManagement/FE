    ...
    <div className="min-h-[60vh] px-4 py-6 sm:px-6 lg:px-8">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-6">
        <div className="rounded-[2rem] border border-slate-200 dark:border-slate-800 bg-card p-6 shadow-sm">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-3 animate-pulse">
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          <div className="h-56 w-full rounded-[2rem] animate-pulse bg-slate-100 dark:bg-slate-800" />
          <div className="h-56 w-full rounded-[2rem] animate-pulse bg-slate-100 dark:bg-slate-800" />
        </div>
      </div>
    </div>
